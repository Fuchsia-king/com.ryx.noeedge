...
public class AddonsDTO implements java.io.Serializable {
	...
	/** minimal constructor */
	public AddonsDTO(String name, String title, Boolean status,
	...
	/** full constructor */
	public AddonsDTO(String name, String title, String description,
