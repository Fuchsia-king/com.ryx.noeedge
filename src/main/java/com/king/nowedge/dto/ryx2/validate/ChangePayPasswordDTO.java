...
public class ChangePayPasswordDTO implements java.io.Serializable {
	...
	@NotEmpty(message="{pay.password.new.not.empty}")
	private String newPassword;
	
	
	@NotEmpty(message="{pay.confirmNewPassword.not.empty}")
