...
public class AddonsQuery extends LoreBaseQuery {
	...
	/** minimal constructor */
	public AddonsQuery(String name, String title, Boolean status,
	...
	/** full constructor */
	public AddonsQuery(String name, String title, String description,
