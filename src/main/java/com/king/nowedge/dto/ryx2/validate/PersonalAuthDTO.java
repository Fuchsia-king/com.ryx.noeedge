...
public class PersonalAuthDTO implements java.io.Serializable {
	
	private Long id ;
	@NotEmpty(message="{personalAuth.nickname.not.empty}")
	...
	@NotNull(message="{personalAuth.flag.not.empty}")
	private Integer flag;
	
	private Integer status ;
	
	//@NotEmpty(message="{personalAuth.dcode.not.empty}")
	private String dcode;
	
	//@NotEmpty(message="{personalAuth.dnPic1.not.empty}")
	private String dpic1;
	
	//@NotEmpty(message="{personalAuth.dnPic2.not.empty}")
	private String dpic2;
	
	@NotEmpty(message="{personalAuth.mobile.not.empty}")
	private String mobile;
	
	//@NotEmpty(message="{personalAuth.phone.not.empty}")
	...
	//@NotEmpty(message="{personalAuth.introduction.not.empty}")	
	private String introduction;
	private String accountHolder;
	private String bankAccount;
	
	//@NotEmpty(message="{personalAuth.contact.not.empty}")
	private String contact;
	
	//@NotEmpty(message="{personalAuth.fname.not.empty}")
	private String fname;
	
	private Integer passTime;
	
	
	//@NotEmpty(message="{personalAuth.imageUrl.not.empty}")
	private String imageUrl ;
	
	//@NotEmpty(message="{personalAuth.tags.not.empty}")
	private String tags;
	
	//@NotEmpty(message="{personalAuth.beGoodAt.not.empty}")
	private String beGoodAt ;
	

	
	
	@NotEmpty(message="{personalAuth.isAgreeProtocal.not.empty}")
	 ...
	 * 规模
	 */
	//@NotNull(message="{personalAuth.scale.not.empty}") 
	private Integer scale;
	
	/**
	 * 行业
	 */
	//@NotNull(message="{personalAuth.industry0.not.empty}") 
	 ...
	 * org type ，机构类型
	 */
	//@NotNull(message="{personalAuth.otype.not.empty}")
