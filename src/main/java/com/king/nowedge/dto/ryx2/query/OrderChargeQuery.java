...
public class OrderChargeQuery extends LoreBaseQuery implements java.io.Serializable {
	...
	/** default constructor */
	public OrderChargeQuery() {
	}

	/** full constructor */
	public OrderChargeQuery(String orderType, String payType,
