package com.king.nowedge.dto.three;
...
public class UserInfo implements Serializable, UserDetails {
    ...
    private Long sid ;//邀请人Id
    private String icode;//邀请码
    private String orate ;//佣金比例
    ...
    public UserInfo(String username,String password,List roles){
