...
public class RyxUsersFavoriteQuery extends LoreBaseQuery implements java.io.Serializable {
	...
	/** default constructor */
	public RyxUsersFavoriteQuery() {
	}

	/** full constructor */
	public RyxUsersFavoriteQuery(String keepType, String objType, Integer originId,
