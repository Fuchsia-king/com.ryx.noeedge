...
public class RyxAddonsQuery extends LoreBaseQuery {
	...
	/** default constructor */
	public RyxAddonsQuery() {
	}

	/** minimal constructor */
	public RyxAddonsQuery(String name, String title, Boolean status,
	...
	/** full constructor */
	public RyxAddonsQuery(String name, String title, String description,
