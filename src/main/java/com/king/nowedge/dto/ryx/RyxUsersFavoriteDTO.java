...
public class RyxUsersFavoriteDTO implements java.io.Serializable {
	...
	/** default constructor */
	public RyxUsersFavoriteDTO() {
	}

	/** full constructor */
	public RyxUsersFavoriteDTO(String keepType, String objType, Integer originId,
