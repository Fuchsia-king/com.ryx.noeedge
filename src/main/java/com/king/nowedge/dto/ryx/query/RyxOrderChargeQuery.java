...
public class RyxOrderChargeQuery extends LoreBaseQuery implements java.io.Serializable {
	...
	/** default constructor */
	public RyxOrderChargeQuery() {
	}

	/** full constructor */
	public RyxOrderChargeQuery(String orderType, String payType,
