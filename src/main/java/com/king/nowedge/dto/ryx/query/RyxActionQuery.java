...
public class RyxActionQuery extends LoreBaseQuery  {
	...
	/** default constructor */
	public RyxActionQuery() {
	}

	/** minimal constructor */
	public RyxActionQuery(String name, String title, String remark, Short type,
	...
	/** full constructor */
	public RyxActionQuery(String name, String title, String remark, String rule,
