...
public class RyxConfigQuery extends LoreBaseQuery implements java.io.Serializable {
	...
	/** default constructor */
	public RyxConfigQuery() {
	}

	/** full constructor */
	public RyxConfigQuery(String name, Short type, String title, Short group,
